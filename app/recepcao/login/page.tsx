...
/**
 * app/recepcao/login/page.tsx
 * Tela de login da recepção — redireciona para /recepcao após autenticação
 */

import { useState } from 'react'
import { useRouter } from 'next/navigation'
import Image from 'next/image'
import { loginRecepcao } from '@/app/actions/recepcao-auth'
...
export default function LoginRecepcao() {
  ...
  async function logar() {
    ...
    const { ok } = await loginRecepcao(senha)
  ...
  return (
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        <h1 style={s.titulo}>Recepção</h1>
        <p style={s.sub}>Painel administrativo — AD Vinhedo</p>
