    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/ibuc/aluno/notas" className="bg-indigo-600 
          ...
          <Link href="/ibuc/aluno/materiais" className="bg-indigo-600 
              text-white p-4 rounded-2xl shadow-lg shadow-indigo-200 
              hover:bg-indigo-700 hover:-translate-y-1 transition-all">
            <span className="text-2xl mb-2 block">📚</span>
            <span className="font-bold text-sm">Materiais</span>
          </Link>
          <Link href="/ibuc/aluno/financeiro" className="bg-indigo-600 
              text-white p-4 rounded-2xl shadow-lg shadow-indigo-200 
              hover:bg-indigo-700 hover:-translate-y-1 transition-all">
            <span className="text-2xl mb-2 block">💰</span>
            <span className="font-bold text-sm">Financeiro</span>
          </Link>
          <Link href="/ibuc/aluno/ebd" className="bg-indigo-600 
              text-white p-4 rounded-2xl shadow-lg shadow-indigo-200 
              hover:bg-indigo-700 hover:-translate-y-1 transition-all">
            <span className="text-2xl mb-2 block">📖</span>
