...
export default async function PerfilAlunoAdminPage({ params }: { params: { id: string } }) {
  ...
  if (!temAcesso) {
    redirect('/ibuc/aluno') // Impede que o aluno veja o perfil dos outros
  }
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-8">
          <Link href="/ibuc/admin/alunos" className="text-sm text-gray-500 hover:text-indigo-600 flex items-center gap-2 transition">
            ← Voltar para a lista
          </Link>
