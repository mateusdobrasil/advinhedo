...
export default async function RelatoriosPage() {
  ...
  const temAcesso = await usuarioTemAcessoPagina(supabase, perfil?.tipo_usuario, 'ebd', 'relatorios')
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-3">
            <Link href="/aplicacao/ebd/admin/relatoriosEBD" className="text-sm bg-indigo-50 border border-indigo-100 text-indigo-700 px-5 py-2.5 rounded-xl font-bold hover:bg-indigo-100 transition shadow-sm">
              Ver Relatório da EBD ➡️
            </Link>
            <Link href="/aplicacao/ebd/admin" className="text-sm bg-white border border-gray-200 text-gray-700 px-5 py-2.5 rounded-xl font-bold hover:bg-gray-50 transition shadow-sm">
              Voltar ao Hub
            </Link>
          </div>
        </div>
