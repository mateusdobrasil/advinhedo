...
export default async function AdminMateriaisPage() {
  ...
  const temAcesso = await usuarioTemAcessoPagina(supabase, perfil?.tipo_usuario, 'ebd', 'materiais')

  if (!temAcesso) {
    redirect('/aplicacao/ebd') // Redireciona alunos e sem acesso
  }
