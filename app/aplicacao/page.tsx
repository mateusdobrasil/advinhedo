        ...
        <main>
          ...
          <section className="bg-gradient-to-b from-blue-900 to-indigo-900 text-white py-20 sm:py-24 px-6 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              {/* 👇 BOTÕES DE AÇÃO COM O LOGIN RESTAURADO 👇 */}
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <a href="#cursos" className="bg-white text-blue-900 px-8 py-3.5 rounded-full font-bold hover:bg-gray-100 transition shadow-lg w-full sm:w-auto">
                  Conhecer os Cursos
                </a>
                <Link href="/aplicacao/ibv/login" className="bg-blue-800 border border-blue-400 text-white px-8 py-3.5 rounded-full font-bold hover:bg-blue-700 transition shadow-lg w-full sm:w-auto flex items-center justify-center gap-2">
                  <span>🔒</span> Acessar o Portal
                </Link>
              </div>
