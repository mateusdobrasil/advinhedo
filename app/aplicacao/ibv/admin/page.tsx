...
export default async function AdminPage() {
  ...
  const modulos = [
    { nome: 'Cadastro Central', icon: '📇', link: '/aplicacao/ibv/admin/cadastro', desc: 'Gerencie alunos e dados', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
    { nome: 'Alunos', icon: '👥', link: '/aplicacao/ibv/admin/alunos', desc: 'Gestão de estudantes', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
    { nome: 'Diário de Classe', icon: '✅', link: '/aplicacao/ibv/admin/diario', desc: 'Notas e presenças', ativo: true, permissoes: ['Administrador', 'Administrativo', 'Professor'] },
    { nome: 'Mural de Avisos', icon: '📢', link: '/aplicacao/ibv/admin/avisos', desc: 'Publique recados globais', ativo: true, permissoes: ['Administrador', 'Administrativo', 'Professor'] },
    { nome: 'Turmas', icon: '🏫', link: '/aplicacao/ibv/admin/turmas', desc: 'Organize as salas', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
    { nome: 'Matrículas', icon: '📝', link: '/aplicacao/ibv/admin/matriculas', desc: 'Aprovações e inscrições', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
    { nome: 'Cursos', icon: '🏛️', link: '/aplicacao/ibv/admin/cursos', desc: 'Grade curricular', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
    { nome: 'Matérias', icon: '📚', link: '/aplicacao/ibv/admin/materias', desc: 'Disciplinas e conteúdos', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
    { nome: 'Relatórios', icon: '📊', link: '/aplicacao/ibv/admin/relatorios', desc: 'Métricas e gráficos', ativo: true, permissoes: ['Administrador', 'Administrativo'] },
  ...
  // FILTRO ÚNICO: Apenas Permissão de Cargo (O escopo ibv já está garantido pela pasta)
