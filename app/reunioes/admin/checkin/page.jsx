    ...
    return (
      <div style={m.selecaoContainer}>
        <div style={m.selecaoWrap}>
          ...
          <button style={m.voltarSolto} onClick={() => router.push('/reunioes/admin')}>← Voltar</button>
        </div>
      </div>
    )
  }
  ...
  if (!isKiosk) {
    return (
      <div style={m.container}>
        ...
        <div style={m.header}>
          <button style={m.voltarBtn} onClick={() => router.push('/reunioes/admin')}>←</button>
    ...
    <div style={k.container}>
      ...
      <div style={k.esquerda}>
        ...
        <div style={k.rodape}>
          ...
          <button style={{ ...k.btnRodape }} onClick={() => router.push('/reunioes/admin')}>Admin</button>
        </div>
      </div>
